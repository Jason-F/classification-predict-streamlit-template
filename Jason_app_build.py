...
def main():
    ...
    if selection == 'Information':
        ...
        st.markdown(""" We have created a machine learning classification model, that would be able to accurately classify a persons belief sentiment 
    ...
    if selection == 'Team Members':
        ...
        st.write('**Jason Farrell** - Lead Developler')
        st.write('**Keletso Pule** - Model Anaylst')
        st.write('**Dineo Mahlangu** - Model Anaylst')
        st.write('**Melusi Zwane** - AWS Deployment')
        st.write('**Chwayita Happiness** - Testing Specialist')
        st.image('resources/imgs/EDSA_logo.png',use_column_width=True)
